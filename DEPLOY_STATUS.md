# Deploy status (2026-09-21, source commit d54341e)
...
NOT READY TO DEPLOY -- 5 blocking issue(s):
  ...
  4. severity_bands.js: the four-band PPD screening classification is unsigned (and its band edges are not yet checked against the DASS manual) -- a clinician must review the bands, labels and results wording and sign it before any deployment.
